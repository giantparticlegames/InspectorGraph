...
![Window Sample](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/WindowSample.png)
...
![Project Settings](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ProjectSettings.png)
...
![Type Selection Popup](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/TypeSelectionPopup.png)
...
![View Menu](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ViewMenu.png)
...
![Filters](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ViewMenu-Filters.png)
...
| ----------------------------------------------------------- | --------------------------------------------------------- |
| ![Script View Disabled](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ViewMenu-ShowScripts-Off.png) | ![Script View Enabled](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ViewMenu-ShowScripts-On.png) |
...
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| ![Prefab References View Disabled](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ViewMenu-ShowPrefabReferences-Off.png) | ![Prefab References View Enabled](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ViewMenu-ShowPrefabReferences-On.png) |

### Edit Menu
The **Edit** menu currently has only one option that opens the Inspector Graph [project settings](#project-settings).

![Edit Menu](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/EditMenu.png)

### Help Menu
The **Help Menu** has useful links

![Help Menu](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/HelpMenu.png)
...
![Inspected Object Reference](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectedObjectReference.png)
...
![Zoom Controls](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/ZoomControls.png)

## Inspector Window
The inspector window is a small version of the Unity inspector with extra functionality to better visualize references.

![Inspector Window](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow.png)

### Window controls
Currently, the window can be minimized or extended using the buttons at the top left corner.

![Window Controls](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-WindowControls.png)

* Minimize: The minimize button (Yellow) will collapse the window leaving only the header and the window controls visible.

![Window - Minimized](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-Minimized.png)

* Extend: The extend button (Green) will eliminate the height restrictions allowing for the entire inspector to be displayed.

![Window - Extended](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-Extended.png)
...
![Window - Toolbar](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-Toolbar.png)

### Footer
At the bottom of the window you will be able to see more information and controls.

![Window - Footer](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-Footer.png)
...
![View Modes](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-ViewModes.png)
...
![Inspector Element Mode](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-ViewMode-InspectorElement.png)
...
![IMGUI Mode](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-ViewMode-IMGUI.png)
...
![Preview Mode](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-ViewMode-Preview.png)
...
| ---------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| ![Mesh Static Preview](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-ViewMode-Static-Mesh.png) | ![Shader Static Preview](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/InspectorWindow-ViewMode-Static-Shader.png) |
...
![Reference](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/Reference.png)
...
| ------------------------------------------------ | ---------------------------------------------------------- |
| ![Normal References](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/Reference-Normal.png) | ![Highlighted References](https://github.com/giantparticlegames/InspectorGraph/raw/submit_0.10b/.docs/Reference-Highlighted.png) |
